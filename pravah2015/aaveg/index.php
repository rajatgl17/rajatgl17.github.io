...
<!-- header -->
					<header>
						...
						<nav>
							...
							<ul id="menu">
								<li><a href="#!/aavegt"><span></span><strong>AAVEG'15</strong></a></li>
                                ...
                                <li><a href="http://www.skitpravah.com/register" target="_blank"><span></span><strong>Registration</strong></a></li>
                                <li><a href="http://www.skitpravah.com" target="_blank"><span></span><strong>PRAVAH'15</strong></a></li>
							</ul>
						</nav>
					</header>
										...
										<div class="wrapper pad_bot1">
											  <table width="200" border="0">
											    <tr>
											      <td>&nbsp;</td>
                                                  <td ></td>
									<td style="font-size: 107px; padding-left:125px; text-align: center; width: 500px; height: 80px; color: white; padding-top: 66px;">AAVEG<br><br><br><span style="font-size:20px;">23rd - 25th Februray 2015</span></td>
										        </tr>
									      </table><br><br>
<p>To groom, inspire and showcase the champions, SKIT Jaipur   presents AAVEG-2015 All India sports event. Come test your sportsmanship from all over India. 
  ...
  From 23rd to 25th  februray, water your efforts with your sweat and discover how sweet the fruit of victory is.
</p>	
...
<br/>TEAM</h5><br>
										     ...
										     <tr>
										       <td width="50%"><h2>FOOTBALL</h2>
                                                <h5>REGISTRATION FEE: Rs. 1000 PER TEAM For 7A side and Rs. 400 per team for 5A side</h5><br>
									...
									<div class="inner">
										...
										<div class="wrapper">
											<div class="col1">
												...
												<h5 class="cols">Mr. M.K. Beniwal<br></h5>
												<p></p><br>
											</div>
											<div class="col1 pad_left1">
												<h3><a><br><br><br>EVENT COORDINATOR</a></h3>
												<h5 class="cols">Gourav Middha  <br></h5>
												<p>+91 94606-25679<br><a>gouravmiddhagm@gmail.com</a></p><br>
												<h5 class="cols">Naveen Rangwani</h5><br>
												<p>+91 94610-59818</p>
                                          ...
                                          <div class="col1 pad_left1">
												...
												<h5 class="cols">Aman Sharma<br></h5>
												<p>+91 94686-61994</p><br><br>
												<h5 class="cols">Anurag Singh<br></h5>
												<p>+91 96494-04700</p><br>
                                                <h5 class="cols"><br></h5>
                                                <p></p>
							...
							<li id="bb">
								<div class="box1">
									<div class="inner">
                                        ...
                                        <h3><a>Jordy: +91 76119-97393</a></h3>
									</div>
								</div>
							</li> <li id="gali">
								<div class="box1">
									<div class="inner">
                                        ...
                                        <h3>For Details contact:</h3>
                                        <h3><a>Gourav Panwar : +91 97820-40426</a></h3>
                                        <h3><a>Ayan Yogi : +91 96364-07507</a></h3>
									</div>
								</div>
							</li>
                            <li id="vb">
								<div class="box1">
									<div class="inner">
                                        ...
                                        <h3><a>Nitya Prakash : +91 97820-71461</a></h3>
									</div>
								</div>
							</li>
                            <li id="tt">
								<div class="box1">
									<div class="inner">
                                        ...
                                        <h3>For Details contact:</h3>
                                        <h3><a>Amol Dhupar : +91 75977-15694</a></h3>
									</div>
								</div>
							</li>
                            <li id="car">
								<div class="box1">
									<div class="inner">
                                        ...
                                        <h3>For Details contact:</h3>
                                        <h3><a>Atul Kathet: +91 94688-60488</a></h3>
									</div>
								</div>
							</li>
                            <li id="chess">
								<div class="box1">
									<div class="inner">
                                        ...
                                        <h3>For Details contact:</h3>
                                        <h3><a>Raj Gaurav : +91 89470-59713</a></h3>
                                        <h3><a>Abineet</a></h3>
									</div>
								</div>
							</li>
                            ...
                            <li id="pl">
								<div class="box1">
									<div class="inner">
										...
										<h3><strong>RULES & REGULATIONS for Football 7A side</strong></h3>
                                        <ol><br>
                                        ...
                                        <br><br><br>
                                        <h3><strong>RULES & REGULATIONS for Football 5A side</strong></h3>
                                        <ol><br>
                                          <li>Only 5 players are allowed to play in each team (No extra player).</li>
                                          <li>No goalkeeper will be there.</li>
										  <li>player must take care that they wear proper football kit.</li>
										  <li>Refree decision is the last and final decision.</li>
                                        ...
                                        <h3>For Details contact:</h3>
                                        <h3><a>Sameep Periwal : +91 85608-70004</a></h3>
									</div>
								</div>
							</li>
                            <li id="bnt">
								<div class="box1">
									<div class="inner">
                                        ...
                                        <h3>For Details contact:</h3>
                                        <h3><a>Sagar Vashisht: +91 77428-02049</a></h3>
                                         <h3><a>Harshad Hada: +91 98878-92509</a></h3>
									</div>
								</div>
							</li>
						</ul>
